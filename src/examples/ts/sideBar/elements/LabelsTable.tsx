...
interface Props {
    pads: API.PadLabel[]
    changePinName: (pad: API.PadLabel, pinName: string) => void
    deletePad?: (pad: API.PadLabel) => void
}

export const LabelsTable: React.SFC<Props> = ({pads, changePinName, deletePad}) => (
    <div style={{}}>
        ...
        {pads.length === 0 ? 
            ...
            : <div style={{/*maxHeight: "250px",*/ overflow: "auto"}}>
                {pads.map((pad, index) => {
                    return (
                        <div key={`${pad.name}-${pad.naturalX}-${pad.naturalY}`}  
