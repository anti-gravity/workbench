...
export const Banner: React.SFC<Props> = ({children, onClick, title, style}) => (
    <div style={{display: "flex", alignItems: "center", justifyContent: "space-between", height: 64, marginLeft: 32, marginRight: 32, ...style}}>
