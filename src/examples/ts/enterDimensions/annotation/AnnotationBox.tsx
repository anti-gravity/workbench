...
export class AnnotationBox extends React.Component<Props, Partial<State>> {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <div ref={elt => this.wrap = elt}
                style={{display: "flex", position: "absolute", pointerEvents: "auto", cursor: "pointer", transform: translate, zIndex: 100}}
                onMouseEnter={this.handleOnMouseEnter}
                onMouseLeave={this.handleOnMouseLeave}
            >
                <div style={{position: "relative"}}>
                    <div ref={elt => this.inputParent = elt}
                        style={{position: "absolute", top: `0px`, pointerEvents: "auto", display: "flex", flexDirection: direction === "h" ? "column" : "row"}}
                        ...
                        <div style={{display: "flex", backgroundColor: "#4283F2", borderRadius: "2px", padding: "4px", alignItems: "center"}}>
                            <AutosizeInput ref={elt => this.input = elt}
                                ...
                                font={{fontSize: "12px", fontFamily: 'Muli', color: "white"}}
                            ...
                            { (hovered || focused) &&
                                <div style={{color: "white", fontSize: 12, display: "flex", justifyContent: "center", alignItems: "center", cursor: "pointer", marginLeft: 4, pointerEvents: "auto"}}
                                    onClick={() => {onDelete()}}>
                                    x
                                </div>
                            }
